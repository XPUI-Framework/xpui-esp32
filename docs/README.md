...
| [contributing.md](contributing.md) | the target, the fork, [`espflash`](https://crates.io/crates/espflash), the gate in both modes and what CI builds, the five review steps, and how a commit is written |
